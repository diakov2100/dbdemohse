...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(KULContext context)
		{
		...
		static void FilterAndOrder(KULContext context)
		{
		...
		static void Join(KULContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(KULContext context)
		{
			var result = from s in context.Students
		...
		{
			using (KULContext c = new KULContext())
			{
