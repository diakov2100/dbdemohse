...
namespace StudentQueries
{
	class Program
	{
		static void CopyToDatabase(AContext context)
		{
		...
		static void FilterAndOrder(AContext context)
		{
		...
		static void Join(AContext context)
		{
			var result = from s in context.Students
		...
		static void GroupByFirstLetter(AContext context)
		{
			var result = from s in context.Students
